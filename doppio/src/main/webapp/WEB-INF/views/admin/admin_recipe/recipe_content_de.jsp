...
<html> 
	...
	<div class="recipe_content">
		...
		<div class="content" style="width: 100%;">
     		 ...
     		 <div class="재료" style="width: 265px; float: left; border-top: 5px solid #d2d2d2; border-radius:10px; padding-top: 10px; padding-bottom: 5px;">
    		  ...
    		  <div class="레시피" style="width: 500px; float: right; border-top: 5px solid #d2d2d2; border-radius:10px; padding-top: 10px;" >
